    ...
    return (
        <div className=' bg-zinc-800 p-4 md:h-[82vh] md:fixed flex flex-col md:justify-between items-center  md:items-center rounded '>
            ...
            <div className='hidden md:flex flex-col justify-center items-center'>
                ...
                {
                    role == "admin" && <>
                        <Link to={"/profile"} className=' hover:bg-zinc-900 w-full px-4 py-2 mt-2 text-center rounded transition-all duration-300'>All Order</Link>
                        <Link to={"/profile/add-book"} className=' hover:bg-zinc-900 w-full py-2 px-4 mt-2 text-center rounded transition-all duration-300'>Add Book</Link>
