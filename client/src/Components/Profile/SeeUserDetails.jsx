...
function SeeUserDetails({ userDiv, setuserDiv, userDivData }) {
    return (
        <div className={`${userDiv} top-0 left-0 h-screen w-full bg-zinc-800 opacity-20 text-zinc-200`}>
            {userDivData && <div className={` ${userDiv} top-0 left-0 h-screen w-full flex items-center justify-center`}>
                <div className=' bg-zinc-950 w-[80%] md:w-[50%] lg:w-[40%] p-3 rounded-md space-y-3 text-lg text-zinc-200 '>
